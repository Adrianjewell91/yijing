...
"use strict";
const database =
{'[1,1,1,1,1,1]': {character:"乾	qián", title:	"The Creative", description: "Qián (represents) what is great and originating, penetrating, advantageous, correct and firm."},
...
'[1,0,0,0,0,1]': {character:"頤	yí", title:	"Providing Nourishment", description: "Yí indicates that with firm correctness there will be good fortune (in what is denoted by it). We must look at what we are seeking to nourish, and by the exercise of our thoughts seek for the proper aliment."},
'[0,1,1,1,1,0]': {character: "大過	dà guò", title:	"Preponderance of the Great", description: "Dà Guò suggests to us a beam that is weak. There will be advantage in moving (under its conditions) in any direction whatever; there will be success."},
